  ...
  <div>
    <div class="find">
      <div class="top">
        ...
        <el-button type="primary" size="small" class="add" @click="goAdd">新增帖子</el-button>
      </div>
    </div>
    <el-table :data="tableData" border style="margin-top:20px" ref="multipleTable" tooltip-effect="dark" @selection-change="handleSelectionChange" @select="change" @select-all="change" id="#out-table">
      ...
      <el-table-column prop="content" label="内容" :show-overflow-tooltip="true" width="250">
...
export default {
  ...
  methods: {
    ...
    //新增功能
    goAdd() {
      this.$router.push("/group/invitation/add");
    },
    //删除功能
    del(val) {
      val = val.toString();
